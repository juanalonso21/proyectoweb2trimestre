...
const ProductList: React.FC<ProductListProps> = ({ products, isLoading = false, error = null }) => {
  if (isLoading) {
    return (
    ...
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <div className="bg-white p-8 rounded-lg shadow-sm max-w-md mx-auto">
          ...
          <p className="mt-1 text-sm text-gray-500">Intenta con otros filtros o categorías.</p>
        </div>
      </div>
    );
  }
